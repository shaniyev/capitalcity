...
def sendToBot(data):
	greet_bot.send_message('9680894', 'Новое объявление: , {}'.format(data))
...
def main():
	lastURL = 'https://krisha.kz/a/show/50775233'
	base_url = 'https://krisha.kz/prodazha/kvartiry/nur-sultan/?das[who]=1&page=1'
	while True:
		print('Try')
